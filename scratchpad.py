...
existing_cfg = OmegaConf.load("./configs/continual/ds_nlu/1b/mamba_full_wsd.yaml")


from theseus.quick import init
q = init("continual/train/benchmark_mamba", "smoke-test-mamba", "/data/v-houjunliu", config=existing_cfg)
q.config.logging.wandb = False
q.config.training.per_device_batch_size = 2
job = q.create()
job.args.report_interval = 1
