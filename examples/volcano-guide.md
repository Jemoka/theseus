...
clusters:
  ...
  k8s:
    root: /workspace/theseus-data     # where checkpoints/data live on the PVC
    work: /workspace/theseus-work     # scratch/working directory on the PVC
    log: /workspace/theseus-logs      # log directory
...
hosts:
  gpu-cluster:
    ...
    # The cluster paths above (root, work, log) should be under this.
